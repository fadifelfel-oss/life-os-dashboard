...
function getDefaultActions() {
  return [
    ...
    { id: 'nav-live', icon: '⚡', title: 'Use Cases & Prompts', desc: 'Live use case library', keywords: ['use cases', 'prompts', 'library'], execute: () => { window.location.href = 'live.html'; } },
    { id: 'nav-clip', icon: '📎', title: 'Web Clipper', desc: 'View unprocessed clips', keywords: ['clip', 'clipper', 'web', 'inbox'], execute: () => { window.location.href = 'clip.html'; } },
    { id: 'nav-models', icon: '🤖', title: 'Models', desc: 'View available AI models', keywords: ['models', 'ai', 'llm'], execute: () => { window.location.href = 'models.html'; } },
    { id: 'nav-cron', icon: '⏰', title: 'Cron Jobs', desc: 'View scheduled tasks', keywords: ['cron', 'scheduled', 'jobs', 'automation'], execute: () => { window.location.href = 'cron-jobs.html'; } },
